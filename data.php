                        ...
                        <?php
                            ...
                            <tr class="text-center"> <!-- TAMPILAN DATA DALAM TABEL -->
                                ...
                                <td class="text-center">
                                    <!-- BUTTON EDIT -->
                                    <button data-bs-toggle="modal" data-bs-target="#ModalEdit<?php echo $value['id']; ?>"><i class="fa-solid fa-pen-to-square" ></i>
                                    </button>
                                    <!-- MODAL EDIT -->
                                    <div class="modal fade" id="ModalEdit<?php echo $value['id']; ?>"  tabindex="-1" aria-labelledby="ModalEditLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button data-bs-dismiss="modal"><i class="fa-solid fa-xmark" style="color: #000000;"></i></button>
                                                    <button><a href="edit.php?editid=<?php echo $value['id']; ?>" class="fa-solid fa-pen-to-square" style="color: #000633;"></a></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- BUTTON DELETE -->
                                    <button data-bs-toggle="modal" data-bs-target="#ModalDelete<?php echo $value['id']; ?>"><i class="fa-sharp fa-solid fa-trash"></i>
                                    </button>
                                    <!-- MODAL DELETE -->
                                    <div class="modal fade" id="ModalDelete<?php echo $value['id']; ?>" tabindex="-1" aria-labelledby="ModalDeleteLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button data-bs-dismiss="modal"><i class="fa-solid fa-xmark" style="color: #000000;"></i></button>
                                                    <button><a href="data.php?deleteid=<?php echo $value['id']; ?>" class="fa-solid fa-trash" style="color: #000633;"></a></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- BUTTON PRINT -->
                                    <button data-bs-toggle="modal" data-bs-target="#ModalShowData<?php echo $value['id']; ?>"><i class="fa-solid fa-eye" style="color: #000000;"></i>
                                    </button>
                                    <!-- MODAL PRINT -->
                                    <div class="modal fade" id="ModalShowData<?php echo $value['id']; ?>" role="dialog" tabindex="-1" aria-labelledby="ModalShowDataLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button><a href="cetakid.php?showid=<?php echo $value['id']; ?>" target="_blank" class="fa-sharp fa-solid fa-print" style="color: #000633;"></a></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
